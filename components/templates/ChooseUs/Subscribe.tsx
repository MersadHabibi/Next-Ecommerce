...
export default function Subscribe() {
  return (
    <div className="flex w-full flex-col-reverse items-center justify-between rounded-lg border border-secondry px-5 py-3 dark:border-secondry-dark sm:flex-row sm:items-start">
