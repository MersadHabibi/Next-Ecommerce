...
import ChooseUsAccordionItem, { ChooseUsAccordionItemProps } from "./ChooseUsAccordionItem";
...
export default function ChooseUsAccordions() {
  return (
    <Accordion
      ...
      collapsible
      className={cn(
        "border-secondary dark:border-secondary-dark space-y-5 rounded-lg border bg-neutral-100 p-5 dark:bg-neutral-950",
      )}>
